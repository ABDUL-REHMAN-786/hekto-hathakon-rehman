  ...
  return (
    <div className=" relative w-full bg-[#F3F3F3] overflow-hidden flex flex-col md:flex-row items-center justify-between">
      ...
      <div className="w-full md:w-1/2 h-full flex flex-col md:flex-row items-center justify-start pl-6 md:pl-16 relative">
        ...
        {/* Bulb Image - Adjusting position and size */}
        <div className="relative m-10 pl-5 sm:absolute ps-0 md:absolute top-[-100px] left-[-600px] md:left-[-120px] md:top-[-80px] z-10">
          <Image
            src="/images/bulb.png" // Ensure this image is located in public/images
            alt="Bulb"
            width={300}
            height={300}
      ...
      {/* Text Content - Aligning next to the bulb */}
        <div className="relative px-40 mt-6 md:mt-0 md:ml-6 text-center md:text-left">
          {/* Pink Text */}
      ...
      <div className="w-full md:w-1/2 h-full relative flex flex-col items-center justify-start">
        ...
        <div
          ...
          style={{ backgroundImage: 'url(/images/pink.png)' }} // Ensure this image is also in public/images
        ></div>

        {/* Sofa Image */}
        <div className="relative z-10 mt-[80px] mb-[20px]">
          <Image
            src="/images/sofa.png" // Ensure this image is in the public/images folder
            alt="Sofa"
            width={350}
            height={250}
            className="object-contain"
        ...
        <div
          ...
          style={{ backgroundImage: 'url(/images/discount.png)' }} // Make sure this image is in public/images
        >
